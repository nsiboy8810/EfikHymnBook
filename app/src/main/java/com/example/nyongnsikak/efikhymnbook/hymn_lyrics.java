...
public class hymn_lyrics extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getHymnNo = hymn_lyrics.getStringExtra("hymns");
        ...
        if (hymnNumber == 1){
            ...
            getHymn = getResources().getString(R.string.hymn33);
            displaySong.setText(getHymn + "");
        }
        else if (hymnNumber == 34) {
